...
insert  into `cards`(`ID`,`cardName`,`ideaID`,`cardCollectionID`,`creationDate`) values (3,'first collectoin card',3,5,'2018-02-08'),(4,'Another collection card',3,6,'2018-02-08'),(5,'Test card',3,5,'2018-02-19'),(6,'asdfsdf',3,6,'2018-02-19');
...
CREATE TABLE `todos` (
  ...
  `todoStatus` varchar(255) DEFAULT NULL,
